...
parser.add_argument('--hr_train_dataset', type=str, default='train_HR/')
parser.add_argument('--model_type', type=str, default='SR-DPN')
...
parser.add_argument('--prefix', default='SR-DPN_8', help='Location to save checkpoint models')
