...
parser.add_argument('--model', default='models/SR_DPN_x8.pth', help='sr pretrained base model')
...
def chop_forward(x, model, scale, shave=8, min_size=80000, nGPUs=opt.gpus):
    ...
    if w_size * h_size < min_size:
        ...
        outputlist = [
            chop_forward(patch, model, scale, shave, min_size, nGPUs) for patch in inputlist
        ]
